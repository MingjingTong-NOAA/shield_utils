...
if [ -s $COMOUT/sfc_data.tile1.nc ]; then
$NLN $COMOUT/sfc_data.tile1.nc   ./anal.tile1.nc
$NLN $COMOUT/sfc_data.tile2.nc   ./anal.tile2.nc
$NLN $COMOUT/sfc_data.tile3.nc   ./anal.tile3.nc
$NLN $COMOUT/sfc_data.tile4.nc   ./anal.tile4.nc
$NLN $COMOUT/sfc_data.tile5.nc   ./anal.tile5.nc
$NLN $COMOUT/sfc_data.tile6.nc   ./anal.tile6.nc
else
$NLN $COMOUT/${iy}${im}${id}.${ih}0000.sfcanl_data.tile1.nc   ./anal.tile1.nc
$NLN $COMOUT/${iy}${im}${id}.${ih}0000.sfcanl_data.tile2.nc   ./anal.tile2.nc
$NLN $COMOUT/${iy}${im}${id}.${ih}0000.sfcanl_data.tile3.nc   ./anal.tile3.nc
$NLN $COMOUT/${iy}${im}${id}.${ih}0000.sfcanl_data.tile4.nc   ./anal.tile4.nc
$NLN $COMOUT/${iy}${im}${id}.${ih}0000.sfcanl_data.tile5.nc   ./anal.tile5.nc
$NLN $COMOUT/${iy}${im}${id}.${ih}0000.sfcanl_data.tile6.nc   ./anal.tile6.nc
fi
...
if [ ! -d $COMOUT/sfcanl ]; then
  mkdir -p $COMOUT/sfcanl
fi
$NLN $COMOUT/sfcanl/${APREFIX}sfcanl${ASUFFIX} ./sfc.gaussian.file
